...
### 采集聚焦点（在 `collector/config.py` 配置）

- **Base 地**：北京（非北京岗位自动跳过）
- **岗位方向**：交互设计、视觉设计、AIGC 设计、UI/UX、用户体验、产品经理 等
- **重点公司**（命中自动加星 ★ 并标记类型）：
  - 互联网大厂：腾讯、阿里、字节、美团、百度、京东、拼多多、网易、快手、小米…
  - AI 公司：商汤、智谱、月之暗面、MiniMax、百川、科大讯飞、通义、文心…
  - 外企：Apple、Google、Microsoft、Meta、Amazon、NVIDIA、Adobe、SAP、IBM…

抓取的岗位会按「北京 + 重点公司 + 设计岗」综合优先级排序，重点岗位置顶。
